...
public class ServiceServiceLocator extends org.apache.axis.client.Service implements com.vlms.sjsu.service.ServiceService {
    ...
    private java.lang.String Service_address = "http://localhost:8080/VLMS/services/Service";
    ...
    public com.vlms.sjsu.service.Service getService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.vlms.sjsu.service.ServiceSoapBindingStub _stub = new com.vlms.sjsu.service.ServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.vlms.sjsu.service.Service.class.isAssignableFrom(serviceEndpointInterface)) {
                com.vlms.sjsu.service.ServiceSoapBindingStub _stub = new com.vlms.sjsu.service.ServiceSoapBindingStub(new java.net.URL(Service_address), this);
                _stub.setPortName(getServiceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://service.sjsu.vlms.com", "ServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://service.sjsu.vlms.com", "Service"));
        }
